...
/**
 * sys_deploymodule_function
 *
 * @author
 */
@Table(name = "sys_deploymodule_function")
public class AppFunction implements Serializable {
    ...
    @UpdateIgnore
    private List<AppFunction> child;

    public List<AppFunction> getChild() {
        return child;
    }

    public void setChild(List<AppFunction> child) {
        this.child = child;
    }
