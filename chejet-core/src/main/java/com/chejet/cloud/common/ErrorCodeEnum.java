...
public enum ErrorCodeEnum {
    ...
    USER_ROLE_INVALID(9015, "在本系统中未授权角色"),
    ...
    DEPARTMENT_IS_NOT_NULL(9110,"部门不能为空"),
    DEPARTMENT_DELETE_HAS_CHILD(9111,"该部门拥有子部门不能删除"),
    DEPARTMENT_DELETE_HAS_EMPLOYEE(9112,"该部门仍有在职员工不能删除"),
    /**
     * 员工异常码
     */
    ...
    EMPLOYEE_IS_TENANT(9210,"此员工是租户管理员，不允许设置为企业管理员"),
    ...
    COMPANY_HAS_ENABLE_CHILD(9310,"公司下有未禁用的子公司"),
    COMPANY_CAN_NOT_BE_SELF(9311,"上级企业不能选择当前企业"),
    COMPANY_CAN_NOT_BE_CHILD(9312,"上级企业不能选择下属企业"),
    COMPANY_CAN_NOT_BE_DISABLED(9313,"上级企业不能是禁用状态"),
    COMPANY_NO_AUTH_APP(9314,"企业无授权应用"),
     ...
     * 租户
     */
    TENANT_ID_ERROR(9500,"租户ID取不到"),
    TENANT_CANNOT_BE_EMPLOYEE(9501,"租户管理员不能注册为该公司下普通员工"),


    /**
     * 应用角色
     */
    APP_ROLE_LITS_NONEXISTS(9601,"该公司应用角色列表为空"),
    APP_DEPLOY_LIST_EXISTS(9602,"对应APP的配置包列表为空"),
    APPLICATION_PARAMETERS_NOT_REGISTERED(9603, "应用参数未注册"),
    APP_DEPLOY_NOT_FIND(9604,"配置包不存在"),

    /**
     * 角色异常
     * */
    ROLES_NOT_FOUND(9701,"角色不存在"),
    ADD_ROLES_FIELD(9702,"角色添加失败"),
    ALLOW_REPLACEMENT(9703,"允许创建"),
    REPLACE_ADMIN_FIELD(9704,"新账号已经为本租户的租户管理员，不允许更换。"),
    ROLE_CONFLICT(9705,"此账号已经为本租户的企业管理员，将替换为本租户的租户管理员?"),
    PHONE_NOT_CORRECT(9706,"此手机号不是租户管理员"),
    PHONE_IS_DIFFERENT(9707,"与校验的手机号码不一致"),
    ROLE_HAS_SAME_NAME(9708,"角色名重复"),

    /**
     * 个人资料、手机号异常
     */
    TELEPHONE_EXIST(9801,"手机号已被注册!"),
    /**
     * 数据库异常码
     */
